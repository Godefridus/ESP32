...
void convertControlpad() {
  convert = false;
  Serial.print("      ");
  if (rxString == "!B11:") Serial.println("********** Control Action 1");
  else if (rxString == "!B219") Serial.println("********** Control Action 2");
  else if (rxString == "!B318") Serial.println("********** Control Action 3");
  else if (rxString == "!B417") Serial.println("********** Control Action 4");
  else if (rxString == "!B516") Serial.println("********** Control Action UP");
  else if (rxString == "!B615") Serial.println("********** Control Action DOWN");
  else if (rxString == "!B714") Serial.println("********** Control Action LEFT");
  else if (rxString == "!B813") Serial.println("********** Control Action RIGHT");
  rxString = "";
}
